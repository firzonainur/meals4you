...
if (isset($_POST['update_pesanan'])) {
  ...
  $atas_nama = $_POST['usr_transaksi'];
  $jumlah =  $_POST['jumlah'];
  $harga =  $_POST['harga'];
  $id_menu =  $_POST['id_menu'];
  //$total = mysqli_fetch_array($jumlah) * mysqli_fetch_array($harga);
  //$total = $_POST['total'];
  $tgl = date('Y-m-d');
...
if (isset($_POST['add'])) {
  ...
  VALUES ('','$_POST[kd_transaksi]','$tgl','$_POST[no_meja]','$_POST[usr_transaksi]','total='$total[$i]'')");
}
  $id_pemesanan = $kd_transaksi;
  for ($i = 0; $i < $jumlah_menu; $i++) {
    ///////////////////perulanagan 
                   ...
                   order by a.tgl asc");
                          ...
                          ?>
                            <tr>
                              ...
                              <td><input type="hidden" name="" value='<?php echo "$r[harga]*$r[jumlah]" ?>' /><?php echo $r[harga]*$r[jumlah] ?>
